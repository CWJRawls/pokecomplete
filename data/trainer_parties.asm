...
ErikaData:
	db $FF,30,VICTREEBEL,30,TANGELA,32,VILEPLUME,32,EXEGGCUTE,35,VENASAUR,0
KogaData:
	db $FF,40,KOFFING,40,MUK,42,VENEMOTH,42,MUK,45,WEEZING,0
BlaineData:
...
LanceData:
	db $FF,95,GYARADOS,95,DRAGONAIR,96,DRAGONAIR,97,AERODACTYL,99,DRAGONITE,0
